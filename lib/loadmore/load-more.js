...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const filterButtons = document.querySelectorAll("#workfolio-filter li");
  const workfolioItems = document.querySelectorAll(
    ".workfolio-container .workfolio-item"
  );
  const loadMoreButton = document.getElementById("load-more");
  const allDavieFolioItems = document.querySelectorAll(
    ".daviefolio-narrow-content .workfolio-item.hidden"
  );
  ...
  function filterHiddenItems() {
    ...
    const filteredItems = document.querySelectorAll(
      `.daviefolio-narrow-content ${activeFilter}.hidden`
    );
...
document.addEventListener("DOMContentLoaded", function () {
  const filterButtons = document.querySelectorAll("#workfolio-filter li");
  const allWorkfolioItems = document.querySelectorAll(
    ".daviefolio-narrow-content .workfolio-item"
  );
  const loadMoreButton = document.getElementById("load-more");
